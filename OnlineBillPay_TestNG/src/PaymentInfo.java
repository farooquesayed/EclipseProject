...
public class PaymentInfo {
	...
	public static boolean AllPaymentInformation(WebDriver browserDriver) {
		System.out.println("Entering All Payment Method method");
		DRIVER = browserDriver;
		
		if(!Common.chpt_Exists(DRIVER, "paymentMethod")) return false;
	...
	public void verifyScreenNavigation() {
		if(Common.isElementPresent(DRIVER, "bSubmitPayment")) 
